 ...
 * 
 */
public class CzekanowskiDistanceMeasure implements Measure, HasCategory {
	...
	public String getName() {
		return "Czekanowski Measure (Intersection Family)";
	}
	...
	@Override
	public Class<CzekanowskiDistanceMeasure> getType() {
		return CzekanowskiDistanceMeasure.class;
	}
